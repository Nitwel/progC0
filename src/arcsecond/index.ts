...
export {encoder, decoder, Parser, updateData, updateError, updateParserState, updateResult, InputTypes, getCharacterLength, getNextCharWidth, getString, getUtf8Char}
